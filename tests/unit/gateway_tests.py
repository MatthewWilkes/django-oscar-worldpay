...
class TestUrlGeneration(TestCase):
    ...
    def test_md5_generation(self):
        url = build_payment_url(b'12345', b'6789', b'12.00', b'GBP', M_params={b'one': b'two'}, secret=b"gobbledegook", SignatureFields=('cartId', 'currency', 'amount'), MD5Secret=b'foo', test_mode=True)
        self.assertIn('testMode', url)
